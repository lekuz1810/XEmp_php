...
<html lang="en">
  ...
  <body>
    ...
    <!-- Contact Us -->
    <div class="MainCommonSection max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <div class="max-w-2xl lg:max-w-5xl mx-auto">
        <div class="text-center">
          <h1 class="color-secondarytext-3xl font-bold text-gray-800 sm:text-4xl">
            Contact us
          </h1>
          <p class="color-secondary mt-1 text-gray-600">
            We'd love to talk about how we can help you.
          </p>
        </div>

        <div class=" color-secondary mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
          <!-- Card -->
          <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
            <h2 class="color-secondary mb-8 text-xl font-semibold text-gray-800">
              Fill in the form
            </h2>
            ...
            <form>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      class="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none focus:outline-none"
              ...
              <div class="mt-4 grid">
                <button
                  type="submit"
                  class="butn w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg  disabled:opacity-50 disabled:pointer-events-none"
                >
                  Send inquiry
                </button>
              </div>
          ...
          <div class="divide-y divide-gray-200">
            ...
            <div class="flex gap-x-7 py-6">
              ...
              <div class="grow">
                ...
                <a
                  class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                  href="#"
                >
                  Contact support
                  <svg
